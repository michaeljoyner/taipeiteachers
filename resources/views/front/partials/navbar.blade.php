<div class="fixed pin-t w-full bg-white z-40 pin-t flex justify-between items-center h-12 border-b-2 border-site-secondary px-4">
    ...
    <ul class="list-reset pl-0 flex-auto block md:flex justify-end items-center text-site-secondary font-cursive nav-menu bg-site-secondary md:bg-white pt-20 md:pt-0">
