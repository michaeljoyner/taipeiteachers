<div class="fixed pin-t w-full bg-white z-40 pin-t flex justify-between items-center h-16 md:h-12 border-b-2 border-site-secondary px-4">
    ...
    <ul class="list-reset pl-0 flex-auto block md:flex justify-end items-center text-site-secondary font-cursive nav-menu bg-site-primary md:bg-white pt-20 md:pt-0">
        <li class="has-dropdown">
            <span class="no-underline font-bold mx-4 text-lg text-white md:text-site-secondary">
            Teachers
            ...
            <div class="dropdown bg-site-primary md:bg-white p-2 pl-6 md:pl-12 md:p-4 md:shadow rounded">
