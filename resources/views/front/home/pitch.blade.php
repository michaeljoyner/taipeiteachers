<div class="max-w-md mx-auto md:mb-28">
    <div class="flex items-start md:items-center text-xl mt-4 mb-4 max-w-lg mx-auto text-site-primary popup an-del-50">
    ...
    <div class="flex items-start md:items-center text-xl mt-4 mb-4 max-w-lg mx-auto text-site-primary popup an-del-100">
    ...
    <div class="flex items-start md:items-center text-xl mt-4 mb-4 max-w-lg mx-auto text-site-primary popup an-del-150">
    ...
    <div class="flex items-start md:items-center text-xl mt-4 mb-4 max-w-lg mx-auto text-site-primary popup an-del-200">
