    ...
    <span>
        ...
        <modal :show="showForm">
            ...
            <div slot="body" class="p-4">
                <vue-form class="max-w-sm mx-auto" :url="url" :form-attributes="formModel" @submission-okay="infoLinkPersisted" button-classes="btn btn-primary ml-6">
                    <div slot="form-body" slot-scope="{formErrors, formData}">
                        <h3 class="text-site-secondary pb-4 border-b-2 border-site-other">Remember, Just the Tip...</h3>
                        ...
                        <div class="form-group my-3" :class="{'has-error': formErrors.content}">
                            <label class="text-sm text-site-secondary font-bold" for="content">Content</label>
                        ...
                        <div class="form-group my-3" :class="{'has-error': formErrors.link}">
                            <label class="text-sm text-site-secondary font-bold" for="link">Link</label>
                        ...
                        <div class="form-group my-3" :class="{'has-error': formErrors.link_text}">
                            <label class="text-sm text-site-secondary font-bold" for="link_text">Link text</label>
                        ...
                        <div class="form-group my-3" :class="{'has-error': formErrors.topic}">
                            <label class="text-sm text-site-secondary font-bold" for="topic">Topic</label>
