<template>
    <div class="h-64 md:px-12 py-8 max-w-md w-full mx-auto rounded bg-white flex flex-col justify-center items-center">
        <form action=""
        class="w-full"
        ...
        >
            ...
            <div class="rounded-full flex items-center" :class="{'shakey border border-red': error}">
                ...
                <button type="submit"
                        ...
                        class="h-12 w-20 md:w-32 bg-site-primary border-t border-b border-r rounded-tr-full rounded-br-full border-site-primary text-white px-4">
